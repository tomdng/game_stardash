            ...
            if boys.job.carry_limit-2 <= (boys.genarium+boys.legendarium+boys.mythicite+boys.rarium):
              ...
              if minerIndex % 7 < 3:
                ...
                for girls in self.game.bodies:
                  if girls.body_type == "asteroid" and girls.material_type == "legendarium" and girls.amount > 2:
                  ...
                  if girls.body_type == "asteroid" and girls.owner == None and girls.amount > 2:
                    girlsPosX = girls.x
                    girlsPosY = girls.y
                ...
                minGirl = None
                for girls in self.game.bodies:
                  if girls.body_type == "asteroid" and girls.material_type == "mythicite":
                    girlsPosX = girls.x
                    girlsPosY = girls.y
                    girlsDistance = ((girlsPosX-boysPosX)**2+(girlsPosY-boysPosY)**2)**(1/2)
                    if girlsDistance < minDistance:
